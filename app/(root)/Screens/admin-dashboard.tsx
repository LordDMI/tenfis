...
export default function AdminDashboard() {
    ...
    return (
        <View className="flex-1 bg-gray-50">
            <View className="bg-white px-4 py-6 border-b border-gray-200 shadow-md">
                <Text className="text-2xl font-bold text-right text-gray-800">لوحة تحكم المدير</Text>
            </View>

            <ScrollView className="flex-1 p-4">
                {/* Statistics Cards */}
                <View className="mb-4">
                    <Text className="text-xl font-bold mb-3 text-right text-gray-800">الإحصائيات</Text>
                    <View className="flex-row flex-wrap justify-between">
                        <View className="bg-white rounded-xl p-4 mb-3 w-[48%] border border-gray-200 shadow-md">
                            <Ionicons name="people" size={32} color="#3b82f6" />
                            <Text className="text-2xl font-bold mt-2 text-right text-gray-800">{stats.totalTherapists}</Text>
                            <Text className="text-gray-600 text-sm text-right">إجمالي الأخصائيين</Text>
                        </View>

                        <View className="bg-white rounded-xl p-4 mb-3 w-[48%] border border-gray-200 shadow-md">
                            <Ionicons name="checkmark-circle" size={32} color="#10b981" />
                            <Text className="text-2xl font-bold mt-2 text-right text-gray-800">{stats.verifiedTherapists}</Text>
                            <Text className="text-gray-600 text-sm text-right">متحقق</Text>
                        </View>

                        <View className="bg-white rounded-xl p-4 mb-3 w-[48%] border border-gray-200 shadow-md">
                            <Ionicons name="time" size={32} color="#f59e0b" />
                            <Text className="text-2xl font-bold mt-2 text-right text-gray-800">{stats.pendingTherapists}</Text>
                            <Text className="text-gray-600 text-sm text-right">قيد المراجعة</Text>
                        </View>

                        <View className="bg-white rounded-xl p-4 mb-3 w-[48%] border border-gray-200 shadow-md">
                            <Ionicons name="person" size={32} color="#8b5cf6" />
                            <Text className="text-2xl font-bold mt-2 text-right text-gray-800">{stats.totalPatients}</Text>
                            <Text className="text-gray-600 text-sm text-right">إجمالي المرضى</Text>
                        </View>

                        <View className="bg-white rounded-xl p-4 mb-3 w-full border border-gray-200 shadow-md">
                            <Ionicons name="calendar" size={32} color="#ef4444" />
                            <Text className="text-2xl font-bold mt-2 text-right text-gray-800">{stats.totalAppointments}</Text>
                ...
                {/* Admin Actions */}
                <View>
                    <Text className="text-xl font-bold mb-3 text-right text-gray-800">الإجراءات</Text>

                    <Pressable
                        onPress={() => router.push('/(root)/Screens/admin')}
                        className="bg-white rounded-xl p-4 mb-4 border border-gray-200 flex-row items-center active:opacity-70 shadow-md"
                    >
                        <Ionicons name="shield-checkmark" size={28} color="#10b981" />
                        <View className="mr-4 flex-1">
                            <Text className="text-lg font-bold text-right text-gray-800">التحقق من الأخصائيين</Text>
                    ...
                    >
                        ...
                        <View className="mr-4 flex-1">
                            <Text className="text-lg font-bold text-right text-gray-800">المنشورات</Text>
                    ...
                    >
                        ...
                        <View className="mr-4 flex-1">
                            <Text className="text-lg font-bold text-right text-gray-800">المواعيد</Text>
                    ...
                    >
                        ...
                        <View className="mr-4 flex-1">
                            <Text className="text-lg font-bold text-right text-gray-800">الملف الشخصي</Text>
