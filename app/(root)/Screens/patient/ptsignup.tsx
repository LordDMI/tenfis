...
export default function PatientForm() {
    ...
    return (
        <SafeAreaView className="flex-1 bg-gray-50">
            ...
            >
                <Text className="text-2xl font-bold mb-5 text-center text-gray-800">تسجيل حساب</Text>
                ...
                {step === 1 && (
                    <>
                        ...
                        {image && <Image source={{ uri: image }} className="w-32 h-32 rounded-full mt-4 self-center shadow-md" />}
                ...
                {step === 3 && (
                    <>
                        ...
                        />
                        <TextInput
                            className="border border-gray-300 rounded-lg p-3 mb-6 h-24 focus:ring focus:ring-blue-300"
